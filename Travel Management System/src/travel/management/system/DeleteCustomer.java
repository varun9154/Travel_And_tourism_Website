...
public class DeleteCustomer extends JFrame {
    ...
    public DeleteCustomer() throws SQLException {
        ...
        // "Check" Button to fetch customer details
        ...
        // "Delete" Button to delete customer record
        ...
        btnDelete.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Error deleting customer: " + e1.getMessage());
                    e1.printStackTrace();
                }
            }
        });
        ...
        // "Back" Button to exit or go back
