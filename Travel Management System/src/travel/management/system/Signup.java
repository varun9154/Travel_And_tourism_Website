...
public class Signup extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            Conn con = new Conn(); // Create a connection instance
            ...
            if (ae.getSource() == b2) {
                ...
                new Login().setVisible(true); // Navigate back to the Login screen
            }
        } catch (Exception e) {
            System.out.println("Error in Signup actionPerformed: " + e);
            e.printStackTrace();
        }
    }
}
